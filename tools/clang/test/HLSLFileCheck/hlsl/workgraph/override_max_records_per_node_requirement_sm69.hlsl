...
// CHECK: [[NODE_1_0]] = !{i32 8, i32 15, i32 13, i32 1, i32 15, {{![0-9]+}}, i32 16, i32 -1, i32 18, {{![0-9]+}}, i32 21, [[OUTPUTS:![0-9]+]]
// CHECK: [[OUTPUTS]] = !{[[OUTPUT1:![0-9]+]]}
// CHECK: [[OUTPUT1]] = !{i32 1, i32 22, i32 2, {{![0-9]+}}, i32 3, i32 [[MAXRECORDS:[0-9]+]], i32 5, i32 128, i32 0, {{![0-9]+}}, i32 7, i32 [[MAXRECORDS]]}
